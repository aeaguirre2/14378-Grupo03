...
<div class="rounded-lg border max-w-md mx-auto my-10 shadow-md bg-gray-800 text-white" data-v0-t="card">
  <form action="loginA.php" method="post">
    <div class="flex flex-col space-y-1.5 p-6">
      <h3 class="tracking-tight text-2xl text-center font-semibold">Veris Administrador</h3>
      <p class="text-sm text-center text-gray-400">Bienvenido, por favor ingrese su cuenta</p>
    </div>
    ...
    <div class="p-6 flex flex-col items-center space-y-4">
      ...
      <div class="flex space-x-4 w-full">
        <button class="inline-flex items-center justify-center text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 px-8 py-2 bg-blue-700 text-white w-full rounded-md hover:bg-blue-800">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <button class="inline-flex items-center justify-center text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 px-8 py-2 bg-red-600 text-white w-full rounded-md hover:bg-red-700">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
