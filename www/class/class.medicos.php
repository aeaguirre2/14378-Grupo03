...
class Medico
{
	...
	public function get_form($IdMedico = NULL)
	{
		...
		$html = '
		<form name="medico" method="POST" action="dashboard.php" enctype="multipart/form-data">
    ...
    <div class="tab" role="tabpanel">
		...
		$res = $this->con->query($sql);
		// Sin codificar <td><a href="dashboard.php?op=del&IdMedico=' . $row['IdMedico'] . '">Borrar</a></td>
		while ($row = $res->fetch_assoc()) {
		...
		if ($num == 0) {
            ...
            <div class="table-responsive">
                <table class="table table-striped mb-0">
					...
					<tr>
						<th colspan="2"><a href="dashboard.php">Regresar</a></th>
						</tr>';
