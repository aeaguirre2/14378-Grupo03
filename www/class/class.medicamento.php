...
class Medicamento
{
	...
	public function get_form($IdMedicamento = NULL)
	{
		...
		$html = '
		<form name="medicamento" method="POST" action="dashboard.php" enctype="multipart/form-data">
    ...
    <div class="tab" role="tabpanel">
		...
		$res = $this->con->query($sql);
		// Sin codificar <td><a href="dashboard.php?op=del&IdMedicamento=' . $row['IdMedicamento'] . '">Borrar</a></td>
		while ($row = $res->fetch_assoc()) {
