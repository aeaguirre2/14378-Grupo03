...
class Rol {
    ...
    public function get_form($idRol = NULL) {
        ...
        $html = '
        <form name="rol" method="POST" action="dashboard.php" enctype="multipart/form-data">
            ...
            <div class="container">
                ...
                <tr>
                    <td>Acciones:</td>
					<td><input type="text" size="15" name="accion" value="' . $this->accion . '" required></td>
                </tr>
                <tr>
                    ...
                    <table class="table table-striped mb-0">
                        ...
                        <tr>
                            <th colspan="8" class="text-center">
                                <a class="btn btn-primary" href="dashboard.php?d=' . $d_new_final . '">Nuevo</a>
                            </th>
                        </tr>
                        <tr>
                            <th>IdRol</th>
