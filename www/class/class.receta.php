...
class Receta
{
	...
	public function get_form($IdReceta = NULL)
	{
		...
		$html = '
		<form name="receta" method="POST" action="dashboard.php" enctype="multipart/form-data">
    ...
    <div class="tab" role="tabpanel">
		...
		$res = $this->con->query($sql);
		// Sin codificar <td><a href="dashboard.php?op=del&IdReceta=' . $row['IdReceta'] . '">Borrar</a></td>
		while ($row = $res->fetch_assoc()) {
