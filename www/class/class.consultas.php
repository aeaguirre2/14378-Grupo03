...
class Consulta
{
	...
	public function get_form($IdConsulta = NULL)
	{
		...
		$html = '
		<form name="consultas" method="POST" action="dashboard.php" enctype="multipart/form-data">
    ...
    <div class="tab" role="tabpanel">
                    <div class="table-responsive">
											...
											<thead style="background-color: black;">
												<th colspan="8" class="text-center" style="color: white;">DATOS DE LA CONSULTA</th>
											</thead>
											<tr>
		...
		$res = $this->con->query($sql);
		// Sin codificar <td><a href="dashboard.php?op=del&IdConsulta=' . $row['IdConsulta'] . '">Borrar</a></td>
		while ($row = $res->fetch_assoc()) {
		...
		if ($num == 0) {
            ...
            <div class="table-responsive">
                <table class="table table-striped mb-0">
					...
					<tr>
						<th colspan="2"><img src="../../imagenes/Usuarios/' . $row['foto'] . '" width="300px"/></th>
					</tr>
					<tr>
