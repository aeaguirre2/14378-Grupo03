...
class Usuario {
    ...
    $html = '<div class="container text-center">
		<form name="usuario" method="POST" action="dashboard.php" enctype="multipart/form-data">
	...
	public function get_list($rol){
		...
		$sql = "SELECT u.IdUsuario AS idUsuario, u.Nombre
                FROM usuarios u;";	
		$res = $this->con->query($sql);
		// Sin codificar <td><a href="dashboard.php?op=del&idUsuario=' . $row['idUsuario'] . '">Borrar</a></td>
		while($row = $res->fetch_assoc()){
