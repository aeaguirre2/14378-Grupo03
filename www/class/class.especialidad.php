 ...
 */	}
	...
	public function get_form($id=NULL){
		...
		<form name="especialidad" method="POST" action="dashboard.php" enctype="multipart/form-data">
	...
	public function get_list($rol){
		...
		$sql = "SELECT e.IdEsp AS idEsp, e.Descripcion, e.Dias
                FROM especialidades e;";	
		$res = $this->con->query($sql);
		// Sin codificar <td><a href="dashboard.php?op=del&idEsp=' . $row['idEsp'] . '">Borrar</a></td>
	...
	*/
        ...
        if($num==0){
            ...
            echo $this->_message_error($mensaje);
				...
				<div class="table-responsive">
					...
					<tr>
						<th colspan="2"><a class="btn btn-primary" href="dashboard.php#especialidad">Regresar</a></th>
						</tr>';
	...
	private function _message_error($tipo){
		...
		<table border="0" align="center">
			...
			<tr>
				<th><a class="btn btn-success" href="dashboard.php">Regresar</a></th>
			</tr>
		</table>';
		return $html;
	}
